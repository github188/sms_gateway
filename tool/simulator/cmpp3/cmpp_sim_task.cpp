...
int time_task(dlist_t *write)
{
    ...
    list_for_each(item, g_phonelist->head, g_phonelist->tail)
    {
        ...
        //报文体序列化
        int body_len = g_cmpp3.make_deliver_req(outbuf, req);
        if( body_len <= 0 )
        {
        ...
        g_cmpp3.make_header(&hdr,writeptr,CMPP3_HEADER_LENGTH);
        //拷贝报文体
