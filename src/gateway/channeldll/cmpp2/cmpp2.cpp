...
int Cmpp2::parse_header(const char* buf, int len, cmpp_header_t* header)
{
...
int Cmpp2::make_header(cmpp_header_t* header, char* buf, int len)
{
    if ( buf == NULL || header == NULL )
    {
        return -1;
...
int Cmpp2::make_connect_req(char *buf, cmpp_body_connect_t body)
{
...
int Cmpp2::make_connect_rsp(char *buf, cmpp_body_connect_resp_t body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::parse_connect_req(char *buf, cmpp_body_connect_t & body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::parse_connect_rsp(char *buf, cmpp_body_connect_resp_t &body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::make_submit_req(char *buf, cmpp_body_submit_t body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::make_submit_rsp(char *buf, cmpp_body_submit_resp_t body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::parse_submit_req(char *buf, cmpp_body_submit_t &body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::parse_submit_rsp(char *buf, cmpp_body_submit_resp_t &body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::make_deliver_req(char *buf, cmpp_body_deliver_t body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::make_deliver_rsp(char *buf, cmpp_body_deliver_resp_t body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::parse_deliver_req(char *buf, cmpp_body_deliver_t &body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
...
int Cmpp2::parse_deliver_rsp(char *buf, cmpp_body_deliver_resp_t &body)
{
    if (buf == NULL)  return -1;
    char *ptr = buf;
